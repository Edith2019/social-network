...
export default function FindProfile() {
    ...
    useEffect(() => {
        console.log("use Effect 3 first users");
    ...
    useEffect(() => {
        // console.log("user change on typing");
    ...
    return (
        <React.Fragment>
            <div className="FindProfile">
                <input type="text" className="userSearch" name="userSearch" placeholder="enter a name" onChange={handleUserSearchChange} />
